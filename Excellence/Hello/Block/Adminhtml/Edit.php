...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        if ($this->_coreRegistry->registry('hello_edit')->getId()) {
            return __("Edit Page '%1'", $this->escapeHtml($this->_coreRegistry->registry('hello_edit')->getTitle()));
        } else {
            return __('New Page');
        }
    }
    ...
    {
        return $this->getUrl('excellence/hello/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
